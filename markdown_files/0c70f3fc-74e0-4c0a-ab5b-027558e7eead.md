...
title: Gnosis Safe 1
---
#DAO #blockchain [dentropydaemon-wiki/Software/List/Solidity](/undefined) [dentropydaemon-wiki/Wiki/Research/DAOs/DAO Protocols and Platforms/Snapshot](/undefined)
...
* Can you do off chain votes for token holders
	* Yes you can use [dentropydaemon-wiki/Software/List/SafeSnap](/undefined)
* Support for [dentropydaemon-wiki/Software/List/Arbitrum](/undefined)
...
* Examples ready for productions
	* [https://github.com/gnosis/zodiac#modules](/undefined)
* Example Code

...
* [SystemD DNS Tutorial](../SystemD DNS Tutorial)
...
* Parsing PDFs
	...
	* NLTK stuff
	* 2. In grade 11 English we would have learned that clauses demonstrate complete thoughts in language
	1. So doing it character wise should involve acknowledgement of "conjunctions" which bridge clauses- e.g. "and", "but", etc

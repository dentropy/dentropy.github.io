...
* Stacy a table with the following data  ( #TODO Followup on table design)
	* No Meme File Found Engine/Pages/discovery - Screen.md#Discovery Screen Example Table]]
...
* Stacy has a question about Randy's first Answer
	* No Meme File Found Engine/Peronas/Randy.md#Randy's First Question]]
	* ![dentropydaemon-wiki/Projects/Quest(ion](/undefined) Engine/Peronas/Randy.md#Randy's First Answer]]

...
* Use [Polars](/Polars) instead of [pandas](/7326b865-6598-4839-bafa-4af8174b0b27)
...
* [Backlog - Discord Scraping](/Backlog - Discord Scraping)
	...
	* [Discord Scraping Logs](/Discord Scraping Logs) - Private
* Discord ETL - Base
	* JSON File SQL Validator
	* Guild Specific Indexing from S3 and file system data
	...
	* Review [Graph QL Alchemy](/Graph QL Alchemy)
...
* Backend
	* Hire a Mentor to tell me which Python API is best
		* Should we use [FastAPI](/FastAPI)
		* Should we use [Flask-SQLAlchemy](/Flask-SQLAlchemy)

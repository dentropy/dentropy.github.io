...
* Post node running
  ...
  * [https://docs.cardano.org/explore-cardano/cardano-architecture/smash-handbook](../https://docs.cardano.org/explore-cardano/cardano-architecture/smash-handbook)
* Resources
...
* [KES and VRF key generation](../[Generate stake pool keys – IOHK Support)](Requires%20wallet)](Requires%20wallet)]])
* [ -z "\$CADDR" ](../ -z "\$CADDR" ))
* Register Stake Pool
...
--
    ...
    [ -z "\$CCLI" ](../ -z "\$CCLI" ) && ( echo "cardano-address cannot be found, exiting..." >&2 ; exit 127 )
    
    CCLI=\${CCLI:=\$( which cardano-cli )}
    [ -e "\$OUT_DIR"  ](../ -e "\$OUT_DIR"  ) && ( echo "cardano-cli cannot be found, exiting..." >&2 ; exit 127 )

...
* [Question Engine Lite Paper and Presentation](../Question Engine Lite Paper and Presentation)
#### TODO

* **Converse Then Structure**
* [ELI5 + Tutorial To Victory](../ELI5 + Tutorial To Victory)
...
* [Epic User Journeys](../c81f0da9-8d82-4176-8458-cfb3d06924c4)
	...
	* [Fuck You Start a Blog](../6af1a3ca-27bf-4695-8c57-5b1118ba2e9c)
* [Logs - Filling self described SQL models via LLM](../Logs - Filling self described SQL models via LLM)
* [Create keybase + discord GUI](../Create keybase + discord GUI)
* [Conduct Investigations using my tools](../Conduct Investigations using my tools)
* [Backlog - DDaemon Design Doc](../Backlog - DDaemon Design Doc)
	* [Activity Streams 2.0](https://www.w3.org/TR/activitystreams-core/) what is missing?
		* There is no private key management stuff
	* I should review Roadmaps using DDaemon
	* I should review startup's out of YC
	* I should review Crypto Tokens
	* I should review DAOs
	* I should review books
	* Self Sovereign Identity that can run inside Acivitypub

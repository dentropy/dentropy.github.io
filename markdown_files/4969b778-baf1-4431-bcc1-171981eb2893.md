---
share: true
uuid: 4969b778-baf1-4431-bcc1-171981eb2893
---
[Unraid | Books](https://unraid.net/community/apps/c/mediaserver-books)
[DDaemon Reference Designs](/7fd81784-994f-4b82-864e-fe340e980358)

## Homelab Projects

* [HomelabOS](https://homelabos.com/)
* [FreeNAS Storage Operating System](https://www.freenas.org/)
...
* [nathancurry/homelab.ansible: Ansible orchestration for my Home Lab](https://github.com/nathancurry/homelab.ansible)

## Homelab Services

* [Seedbox And VPS Hosting In The Netherlands](https://dediseedbox.com/index.php)
* [My Homelab Docker setup | HoldMyBeer](https://holdmybeersecurity.com/2020/05/20/my-homelab-docker-setup/)
* [Setting Up Authelia With SWAG](https://blog.linuxserver.io/2020/08/26/setting-up-authelia/)
* [networking - How do I add a computer to an internal docker network - Server F...](https://serverfault.com/questions/829682/how-do-i-add-a-computer-to-an-internal-docker-network)
* [Yacht Documentation](https://yacht.sh/)
...
* [Endxo - Curated tech search](https://endxo.com/self-hosted)
